...
Route::get('/books/{slug}/reviews', [App\Http\Controllers\API\BookController::class, 'reviews']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/books/{slug}/rate', [App\Http\Controllers\API\BookController::class, 'rate']);
